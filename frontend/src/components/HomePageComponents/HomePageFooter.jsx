        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">My Profile</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="mt-2 flex">
              <input
                ...
                required
              />
              <button className="gradient-bg text-white px-3 py-2 text-sm rounded-r-md" type="submit">
                Subscribe
              </button>
            </form>
          </div>
